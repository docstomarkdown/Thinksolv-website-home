      ...
      <div className="footer-content">
        ...
        <div className="footer-brand-section">
          <Link to="/" className="footer-logo-link">
            <img src="/Favi.png" alt="Thinksolv" className="footer-logo" />
            <span className="footer-brand-name">thinksolv</span>
          </Link>
          <p className="footer-tagline">Building software, thoughtfully.</p>
          <div className="footer-partner-badge">
            <img 
              src="/Google_Cloud_Partner_outline_horizontal.png" 
