...
const EXTENSION_DISPLAY_NAME = "Shopify Spy Pro";

const ShopifySpyProPrivacyPage = () => {
  return (
    <div className="privacy-page">
      ...
      <div className="privacy-content">
        ...
        <section className="privacy-section">
          ...
          <p className="privacy-text">
            Our extension is designed with privacy in mind. It helps you inspect
            and extract information from Shopify-powered storefront pages you visit
            (for example, product, theme, and app-related signals available in the
            page or associated requests). That processing occurs in your browser;
            we do not operate a service that stores your full datasets on our
            servers.
          </p>
          <p className="privacy-text">
        ...
        <section className="privacy-section">
          ...
          <ul className="privacy-list">
            <li>
              <strong>Content Data:</strong> Shopify storefront-related information
              you view or extract using the extension (processed locally in the
              browser, and sent to Google only if you export to Google Sheets)
            </li>
            <li>
        ...
        <section className="privacy-section">
          ...
          <p className="privacy-text">
            Information is used solely to provide storefront insights and export
            features, to maintain extension reliability, and to improve the
            product. We do not use it for unrelated purposes.
          </p>
          <p className="privacy-text">
        ...
        <section className="privacy-section">
          ...
          <p className="privacy-text">
            Data you gather remains on your device within the extension unless you
            export it or clear it. We do not maintain persistent storage of your
            storefront content on our servers.
          </p>
          <p className="privacy-text">
...
export default ShopifySpyProPrivacyPage;
