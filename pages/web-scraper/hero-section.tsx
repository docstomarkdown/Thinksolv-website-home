import { heroContent } from "@/config/page";
import ShinyButton from "@/components/ui/shiny-button";
import GradientText from "../../components/ui/gradient-text";
import WebScrapingVisual from "./web-scaping-component";
      ...
      <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-28 xl:py-32 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
        ...
        <div className="space-y-6 text-center lg:text-left">
          ...
          <div className="pt-2">
            ...
            >
              <ShinyButton className="text-black">
        ...
        {/* Right Side - Visual (responsive square) */}
