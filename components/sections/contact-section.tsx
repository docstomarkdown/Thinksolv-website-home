          ...
          <div className="space-y-6 lg:ml-25">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className={`px-5 py-2 rounded-lg border font-medium font-geist transition-colors ${selectedOption === "contact"
              ...
              <button
                ...
                className={`px-5 py-2 rounded-lg border font-medium font-geist transition-colors ${selectedOption === "calendly"
                  ? "border-bordercolor bg-black text-white"
                  : "border-gray-300 dark:border-gray-600 bg-muted text-foreground hover:text-primary"
                  }`}
              >
